...
class ProgressTracker:
    ...
    async def update_todo(
        ...
        async with self._lock:
            ...
            await self._send_update(
                ...
                message=f"Step {completed_count}/{total_steps} completed" if completed_count > 0 else "Planning complete",
            )
    ...
    async def on_step_complete(self, step_number: int, step_description: str, result: str = "") -> None:
        ...
        await self._send_update(
            ...
            message=f"✅ Step {step_number} completed: {step_description}" + (f" - {result}" if result else ""),
        )
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "progress": f"{self.completed_count}/{self.total_steps}" if self.total_steps > 0 else "N/A",
